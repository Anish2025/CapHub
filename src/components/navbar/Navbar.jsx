            ...
            >
              <Dialog.Panel className="relative flex w-full max-w-xs flex-col overflow-y-auto bg-white pb-12 shadow-xl" style={{ backgroundColor: mode === 'dark' ? 'rgb(40, 44, 52)' : '', color: mode === 'dark' ? 'white' : '', }}>
                ...
                <div className="space-y-6 border-t border-gray-200 px-4 py-6">
                  ...
                  {user?.user?.email === "anishsharma805110@gmail.com" ? <div className="flow-root">
            ...
            <div className="flex h-16 items-center">
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex'>
                  <div className="flex ">
                    ...
                    {/* <img  src='https://drive.google.com/file/d/1J9RSqQ8EJmMsAMbXGXmRKsw7iYefpl2K/view?usp=sharing' h-30 w-30 alt='CapHub'/> */}
                    <img src='./logo.png' alt="Logo" width={40} height={20} loading="lazy" className='rounded' style={{ color: mode === 'dark' ? 'white' : '', }}/>
                  </div>
                </Link>
              </div>
              ...
              <div className="ml-auto flex items-center">
                <div className="hidden lg:flex lg:flex-1 lg:items-center lg:justify-end lg:space-x-6">
                  ...
                  {user?.user?.email === 'anishsharma805110@gmail.com' ?
